...
![image](http://omho9kf1d.bkt.clouddn.com/vi7.JPG)
...
往下说。旁白声音的记录，这里要推另一只神器了。自从我收了它之后，它就是我绝对的收音主力了。这就是Blue YETI。
...
至于最终视频上的程序内容图层，只需要配合photoshop做一个透明低一些的白底圆角图层，铺上想要传达的app相关的内容。生成png，往视频轨上一叠就OK。
